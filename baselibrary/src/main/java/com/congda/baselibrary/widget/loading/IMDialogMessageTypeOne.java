...
public class IMDialogMessageTypeOne {
	private Dialog mDialog;
	private Activity currentActivity;
	private TextView tv_progress;
	private IMAVLoadingIndicatorView animLoding;

	public IMDialogMessageTypeOne(Context context) {
	...
	public IMDialogMessageTypeOne(Context context, DialogInterface.OnKeyListener listener) {
		currentActivity = (Activity) context;
		LayoutInflater inflater = LayoutInflater.from(context);
		View view = inflater.inflate(R.layout.layout_loading_type_one, null);
