...
public class IMChatHeadView extends LinearLayout implements RefreshHeader {
    ...
    public IMChatHeadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }
    public IMChatHeadView(Context context, AttributeSet attrs, int defStyleAttr) {
