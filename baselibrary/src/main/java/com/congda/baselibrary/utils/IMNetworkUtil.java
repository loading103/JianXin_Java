...
import com.congda.baselibrary.app.IMBaseManager;
...
public class IMNetworkUtil {
    ...
    public static boolean isConnected() {
        Context context = IMBaseManager.getInstance().getContext();
    ...
    public static boolean isWifiConnected() {
        ...
        try {
            ConnectivityManager cm = (ConnectivityManager)  IMBaseManager.getInstance().getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
