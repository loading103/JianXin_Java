...
import com.congda.baselibrary.net.converter.GsonConverterBodyFactory;
import com.congda.baselibrary.net.interceptor.CaheInterceptor;
import com.congda.baselibrary.net.interceptor.HeaderInterceptor;
...
//        parameters.put("token", CacheManager.getString("token"));
        parameters.put("Authorization", "E72FF4EA8B04C6AAA00837B605FE7443");
        return parameters;
    }
        ...
        if (retrofit == null) {
            synchronized (BaseRetrofit.class) {
                if (retrofit == null) {
                    ...
                    //设置 请求的缓存的大小跟位置
                    File cacheFile = new File(IMBaseApplication.getContext().getCacheDir(), "cache");
...
//                            .addInterceptor(new ParameterInterceptor(getRequestParams()))  //公共参数添加
                            .addInterceptor(new CaheInterceptor(IMBaseApplication.getContext()))
                    ...
                    retrofit = new Retrofit
                            .Builder()
                            .baseUrl(IMSConfig.BASE_URL)  //baseUrl配置
                            .client(client)
