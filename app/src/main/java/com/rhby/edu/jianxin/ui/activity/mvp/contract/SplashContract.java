...
public interface SplashContract {
    ...
    interface View extends IView {
        void setSplashData(List<SplashAdBean> result);
    }

    interface Model extends IModel {

        Observable<BaseHttpResult<List<SplashAdBean>>> getGetAdJson();

        Observable<BaseHttpResult<VersonBeanData>>   CheckedVersion(String systemType );
    }
}
